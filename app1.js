...
function isHostName(hostname) {
    return hostnames[hostname] === undefined ? false : hostnames[hostname];
}
...
function Resolver() {
    ...
    this.process = function(link, context) {
        ...
        console.log(link, urldata, !isHostName(urldata.hostname));
